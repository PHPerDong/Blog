...
<html>
	<head>
		...
		<link href="/view/Admin/Public/Css/layout.css" rel="stylesheet" type="text/css">
		<link href="/view/Admin/Public/Css/login.css" rel="stylesheet" type="text/css">
		<script type="text/javascript" src="/view/Admin/Public/Js/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="/view/Admin/Public/Js/js.js"></script>
	</head>
	<style>
		.ibar {display: none;}
	</style>
		...
		<div class="main ">
			...
			<div class="login-dom login-max">
				<div class="logo text-center">
					<a href="#">
					<!--<img src="/view/Admin/Public/Images/logo.png" width="180px" height="180px">-->
					</a>
				</div>
				<div class="login container " id="login">
					...
					<form class="login-form" action="<?php echo U('login');?>" method="post" autocomplete="off">
