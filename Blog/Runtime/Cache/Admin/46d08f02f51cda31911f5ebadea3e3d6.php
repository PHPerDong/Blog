                ...
                <div class="list-content show">
                    <div class="offcial-table tr-border margin-big-top clearfix">
                        ...
                        <?php if(is_array($results)): foreach($results as $key=>$res): ?><div class="tr clearfix border-bottom-none">
                                <div class="td w20">
                                    <?php echo ($res['news_title']); ?>
                                </div>
                                <div class="td w20">

                                </div>
                                <div class="td w15">
                                    <?php if($res['news_open'] == 1): ?><a class="button bg-green-deep  icon-button-green " href="#">正常</a>
                                        <?php else: ?>
                                ...
                                <div class="td w15">
                                    <a href="javascript:;" data-id="<?php echo ($res['n_id']); ?>" class="button-word2 newsupdate">编辑</a>
                                    <a href="javascript:;" data-id="<?php echo ($res['n_id']); ?>" msg=""  class="button-word2 btn_ajax_confirm delnewss">删除</a>
                                </div>
                            </div><?php endforeach; endif; ?>
                    </div>
                </div>
